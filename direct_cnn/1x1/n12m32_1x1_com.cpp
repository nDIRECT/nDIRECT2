            ...
            for (cc = ccs; cc < C_to; cc = cc + Cb)         // 0 C Cb
            {
                ...
                for ( ii = iis ; ii < K_to; ii = ii + Kb)   // 0 K Kb
                {
                    ...
                    for(nn = 0; nn < thread_num_inputs; nn++)       // 0 1 1
                    {
                        ...
                        //printf("cc: %d, ii: %d, LEN_HWb: %d, EDGE_HWb: %d, Kb: %d, EDGE_Kb: %d \n", cc, ii, LEN_HWb, EDGE_HWb, Kb, EDGE_Kb);
                        if(LEN_HWb > 0){
                            //printf("here \n");
                            direct_1x1_N12M32_AVX512_pack(buffer_output1, buffer_filter1, buffer_input1, D_Kb, LEN_HWb/32, Cb, input_HW_size<<2, &NDIRECT_input[id * CONV_C * 32], cc, EDGE_Kb);
                        }
                        // edge process ******************************************
                        if(EDGE_HWb != 0)      // 4 1
                        {
                            ...
                            if (EDGE_HWb == 17)
                            {
                                //printf("17 cc: %d, ii: %d, LEN_HWb: %d, EDGE_HWb: %d, Kb: %d, EDGE_Kb: %d \n", cc, ii, LEN_HWb, EDGE_HWb, Kb, EDGE_Kb);
                                direct_1x1_N12M17_AVX512_pack(temp_buffer_output, buffer_filter1, temp_buffer_input, D_Kb, Cb, input_HW_size<<2, &NDIRECT_input[id * CONV_C * 32], cc, EDGE_Kb);                            }

                            else if (EDGE_HWb == 16)
                            {
                                //printf("16 cc: %d, ii: %d, LEN_HWb: %d, EDGE_HWb: %d, Kb: %d, EDGE_Kb: %d \n", cc, ii, LEN_HWb, EDGE_HWb, Kb, EDGE_Kb);
                                direct_1x1_N12M16_AVX512_pack(temp_buffer_output, buffer_filter1, temp_buffer_input, D_Kb, Cb, input_HW_size<<2, &NDIRECT_input[id * CONV_C * 32], cc, EDGE_Kb);                            }
                            else if (EDGE_HWb == 4)
                            {
                                //printf("4 cc: %d, ii: %d, LEN_HWb: %d, EDGE_HWb: %d, Kb: %d, EDGE_Kb: %d \n", cc, ii, LEN_HWb, EDGE_HWb, Kb, EDGE_Kb);
                                direct_1x1_N12M4_AVX512_pack(temp_buffer_output, buffer_filter1, temp_buffer_input, D_Kb, Cb, input_HW_size<<2, &NDIRECT_input[id * CONV_C * 32], cc, EDGE_Kb);                            }
                        }
